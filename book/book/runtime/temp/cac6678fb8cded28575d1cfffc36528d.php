<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"/www/wwwroot/priactise/public/../application/admin/view/news/index.html";i:1651218343;s:59:"/www/wwwroot/priactise/application/admin/view/uekadmin.html";i:1651294367;}*/ ?>
<!doctype html>
<html lang="en">
    ...
    <div class="panel panel-default">
        ...
        <table class="table-bordered table table-hover">
            ...
            <tr>
                ...
                <td><?php echo !empty($vo['update_time'])?$vo['update_time']:"还未更新"; ?></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo url('News/ajax_save'); ?>" method="post" enctype="multipart/form-data" id="editAdminForm">
                </form>
            </div>
