<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\phpstudy_pro\WWW\priactise\public/../application/index\view\recommend\index.html";i:1651175176;s:37:"../application/index/view/common.html";i:1651175069;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="zong">
    ...
    <div class="hot">
        ...
        <div class="catalogue">
            ...
            <ul>
                <?php if(is_array($recommend_data) || $recommend_data instanceof \think\Collection || $recommend_data instanceof \think\Paginator): if( count($recommend_data)==0 ) : echo "" ;else: foreach($recommend_data as $key=>$val): ?>
