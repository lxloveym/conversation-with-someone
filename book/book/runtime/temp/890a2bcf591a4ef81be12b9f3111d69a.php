<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\phpstudy_pro\WWW\priactise\public/../application/index\view\user\index.html";i:1651164208;s:37:"../application/index/view/common.html";i:1651175069;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="mine">
        ...
        <div class="mysaid">
            ...
            <div class="said5">
                <div class="hd">
                    <?php if(isset($name)): ?>
                    <a href="<?php echo url('findone',array('id'=>$name['id'])); ?>"><button class="juan">编辑资料</button></a> <?php endif; ?>
                    <ul>
                        <li>
                        ...
                        <li>
                            <h5>上一次学习时长：</h5> <?php if(isset($name)): ?>
                            <p><?php echo $name['last_time']; ?>小时</p><?php else: ?>
                            <p>游客未统计</p><?php endif; ?>
                        </li>
                    </ul>
                    <?php if(isset($name)): ?>
                    <div class="tu" style="width: 1110px;height: 400px;background: rgba(0, 0, 0, 0.5);margin-top: 40px;">
                    </div>
