<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\phpstudy_pro\WWW\priactise\public/../application/index\view\index\index.html";i:1651174040;s:37:"../application/index/view/common.html";i:1651175069;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="content">
        <div class="neirong">
            <div class="h3">
                ...
                <div class="nei-right">
                    <div class="topText">
                        <div>一杯淡茶，一本书；一缕阳光，一个人</div>
                        <div>是生活，也是人生！</div>
                    </div>
                    <img src="/imagesone/img12.jpeg" alt="">
                </div>
            </div>
            <div class="main1 global">
                ...
                <ul>
                    ...
                    <li blur>
                        <a class="box_a" href="<?php echo url('read',array('id' => $val['id'])); ?>">
                            <div class="zuo1">
