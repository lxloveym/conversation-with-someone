<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/www/wwwroot/priactise/public/../application/admin/view/news/ajax_find.html";i:1651216515;}*/ ?>
<form action="<?php echo url('News/ajax_save'); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label for="">收藏数</label>
        <input type="number" name="collection" class="form-control addAdmin" value="<?php echo $data['collection']; ?>">
        <div class="alert alert-warning"></div>
