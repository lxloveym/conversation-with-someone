<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/www/wwwroot/priactise/public/../application/admin/view/comment/index.html";i:1651218366;s:59:"/www/wwwroot/priactise/application/admin/view/uekadmin.html";i:1651238634;}*/ ?>
<!doctype html>
<html lang="en">
...
<div class="col-md-10">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo url('Comment/index'); ?>">树洞管理</a></li>
    ...
    <div class="panel panel-default">
        ...
        <table class="table-bordered table table-hover">
            ...
            <tr>
                ...
                <td><?php echo !empty($val['update_time'])?$val['update_time']:"还未更新"; ?></td>
                <td>
                    <select name="" onchange="status(this,<?php echo $val['id']; ?>)" class="form-control" id="">
                        <?php switch($val['status']): case "2": ?>
...
<script>
    function status(obj, id) {
        ...
        $.get("<?php echo url('comment/ajax_status'); ?>", {
            status: val,
            id: id
        }, function(data) {
