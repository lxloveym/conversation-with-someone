<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/www/wwwroot/priactise/public/../application/admin/view/collection/index.html";i:1651218488;s:59:"/www/wwwroot/priactise/application/admin/view/uekadmin.html";i:1651294367;}*/ ?>
<!doctype html>
<html lang="en">
    ...
    <div class="panel panel-default">
        ...
        <table class="table-bordered table table-hover">
            ...
            <tr>
                ...
                <td><?php echo !empty($val['update_time'])?$val['update_time']:"还未取消收藏"; ?></td>
                <td>
                    <?php if($val['status'] == 1): ?> 已收藏 <?php elseif($val['status'] == 2): ?>未收藏 <?php endif; ?>
                </td>
            </tr>
